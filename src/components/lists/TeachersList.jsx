import { teachersData } from "../../libs/teacheersList";
              ...
              <tr key={teacher.id}>
                ...
                <td>
                  <div className="flex gap-2">
                    <div
                      className="bg-slate-400 h-10 w-10 flex justify-center items-center
                                         rounded-full opacity-70 cursor-pointer"
                    >
                      <FaRegEye className="text-2xl" />
                    </div>
                    <div
                      className="bg-red-400 h-10 w-10 flex justify-center items-center
                                         rounded-full opacity-70 cursor-pointer"
                    >
